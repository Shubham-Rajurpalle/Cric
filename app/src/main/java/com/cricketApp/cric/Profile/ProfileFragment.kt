...
class ProfileFragment : Fragment() {
    ...
    private fun loadUserChats(userId: String) {
        ...
        chatsRef.orderByChild("senderId").equalTo(userId).limitToLast(5)
    ...
    private fun loadUserMemes(userId: String) {
        ...
        memesRef.orderByChild("senderId").equalTo(userId).limitToLast(5)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
    ...
    private fun loadUserPolls(userId: String) {
        ...
        pollsRef.orderByChild("senderId").equalTo(userId).limitToLast(5)
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
    ...
    private fun loadUserComments(userId: String) {
        // This would require searching through all comments in chats, memes, and polls
        // For simplicity, we'll just load a few recent ones

        // Example for chat comments
